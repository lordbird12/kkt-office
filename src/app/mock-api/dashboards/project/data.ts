...
const day = sessionStorage.getItem('lastweek');
const mon = sessionStorage.getItem('mon');
const tue = sessionStorage.getItem('tue');
const wed = sessionStorage.getItem('wed');
const thu = sessionStorage.getItem('thu');
const fri = sessionStorage.getItem('fri');
const sat = sessionStorage.getItem('sat');
const sun = sessionStorage.getItem('sun');
