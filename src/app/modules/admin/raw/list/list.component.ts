...
export class ListComponent implements OnInit, AfterViewInit {
    ...
    editElement(element: any) {
        this._router.navigate(['admin/raw/edit/' + element]);
    }
    addElement() {
        this._router.navigate(['admin/raw/form']);
    }

    excelExport() {
        window.open(
            'https://laongherbalgroup.com/api/public/api/export_product/3'
        );
    }

    hiddenEdit() {
        const getpermission = JSON.parse(localStorage.getItem('permission'));
        const menu = getpermission.find((e) => e.menu_id === 6);
        return menu.edit === 0;
    }
    hiddenDelete() {
        const getpermission = JSON.parse(localStorage.getItem('permission'));
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                dataTablesParameters.category = '3';
                that._service
