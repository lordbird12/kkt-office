...
export class EditComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        this._service.getWarehouse(this.Id).subscribe((resp: any) => {
            ...
            if(this.warehouseData?.image){
                this.image_url = environment.baseURL + this.warehouseData?.image
            }
    ...
    deleteShelf(element: any) {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                this._service.deleteShelf(element).subscribe({
                    next: (resp: any) => {
                       this.rerender();
                    },
                    error: (err: any) => {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                dataTablesParameters.area_id = this.Id;
    ...
    editShelf(imgObject: any): void {
        this.dialog
            .open(EditShelfComponent, {
                autoFocus: false,
                data: {
                    imgSelected: imgObject,
                },
            ...
            if (result === 'confirmed') {
                ...
                this._service.update(formData).subscribe({
                    next: (resp: any) => {
                        this._service.getWarehouse(this.Id).subscribe((resp: any) => {
                            this.warehouseData = resp.data;
                            this.image_url = this.warehouseData?.image
                            this.dataGrid = this.warehouseData.shelfs;
                            this.form.patchValue({
                                ...this.warehouseData,
                                image: '',
    ...
    backTo() {
        this._router.navigate(['/admin/warehouse/list'])
    }
