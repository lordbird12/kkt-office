...
export class FormUnitDialogComponent implements OnInit {
    ...
    constructor(
        private dialogRef: MatDialogRef<FormUnitDialogComponent>,
    ...
    ngOnInit(): void {
        ...
        if (this.data) {
            ...
            this._service.getbyid(this.data.id).subscribe((resp: any) => {
                console.log(resp);
