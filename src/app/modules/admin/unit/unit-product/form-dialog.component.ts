...
@Component({
    selector: 'edit-dialog-unit-product',
...
export class UnitProductComponent implements OnInit {
    ...
    Unit: any[]
    constructor(
        private dialogRef: MatDialogRef<UnitProductComponent>,
    ...
    onSaveClick(): void {
      if(this.langues == 'tr'){
        ...
        confirmation.afterClosed().subscribe((result) => {
            if (result === 'confirmed') {
                this._service.updateUnitProduct(this.addForm.value).subscribe({
                    next: (resp: any) => {
    ...
    onchange(event: any) {
        ...
        this.itemShelve = this.itemData.shelfs;
        console.log(this.itemData);
    }
    onShelfSelected(event: any): void {
        console.log(event.value);
        this.selectedShelfId = event.value;
        this._service.getFloorAll(this.selectedShelfId).subscribe((resp) => {
    ...
    onfloorSelected(event: any): void {
        ...
        this._service
            .getChannelAll(this.selectedShelfId, selectedfloorId)
            .subscribe((resp) => {
