...
export class EditDialogComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.addForm = this.formBuilder.group({
            ...
            prefix: this.data.data?.prefix,
            category_product_id: this.data.data?.category_product_id,
        });
    }
    ...
    onUpdateClick(): void {
        if (this.langues == 'tr') {
            ...
            confirmation.afterClosed().subscribe((result) => {
                if (result === 'confirmed') {
                    this._service.update_sub(this.addForm.value, this.data.data.id).subscribe({
                        next: (resp: any) => {
