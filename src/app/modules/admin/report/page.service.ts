...
export class PageService {
    ...
    create(data: FormData): Observable<any> {
        return this._httpClient
            .post<any>(environment.baseURL + '/api/factories', data)
            .pipe(
                tap((result) => {
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.baseURL + '/api/stock_trans/' + id,
    ...
    updateStatus(data: any, id: any): Observable<any> {
        return this._httpClient
            .post<any>(environment.baseURL + '/api/update_status_stock', {
                id: id,
                status: data,
            })
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.baseURL + '/api/stock_trans_page',
    ...
    getStockTran(id: any): Observable<any> {
        return this._httpClient
