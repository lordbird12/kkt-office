...
export class EditComponent implements OnInit {
    ...
    constructor(
        ...
        this.editForm = this._formBuilder.group({
            ...
            min_qty_buy: [null, [, Validators.min(1)]],
            free_or_discount_amount: [null,],
            start_date: [null, ],
            end_date: [null, ],
            type: ['', ], // ควรใช้ dropdown หรือ radio button
            status: ['', ] // ควรใช้ dropdown
        });
    ...
    ngOnInit(): void {
        ...
        this._Service.getById(this.Id).subscribe((resp: any) => {
            ...
            this.editForm.patchValue({
                ...this.itemData,
                product_id: this.itemData.product.name,
                product_free_id: this.itemData.product_free.name
            });
